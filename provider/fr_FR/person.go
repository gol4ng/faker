...
var namesFormats = append(maleNameFormats, femaleNameFormats...)

func TitleMale() string {
	return faker.StringIn(titleMale)
}

func TitleFemale() string {
	return faker.StringIn(titleFemale)
}

func Title() string {
	return faker.StringIn(title)
}

func FirstNameMale() string {
	return faker.StringIn(firstNameMale)
}

func FirstNameFemale() string {
	return faker.StringIn(firstNameFemale)
}

func FirstName() string {
	return faker.StringIn(firstName)
}

func Prefix() string {
	return faker.StringIn(prefix)
}

func LastName() string {
	return faker.StringIn(lastName)
}

func NameMale() string {
	return faker.CompileRandValue(maleNameFormats, GetDataProviders())
}

func NameFemale() string {
	return faker.CompileRandValue(femaleNameFormats, GetDataProviders())
}

func Name() string {
	return faker.CompileRandValue(namesFormats, GetDataProviders())
}
